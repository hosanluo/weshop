...
namespace WechatShop\Kernel\Traits;

use WechatShop\Kernel\Contracts\Arrayable;
use WechatShop\Kernel\Exceptions\InvalidArgumentException;
use WechatShop\Kernel\Exceptions\InvalidConfigException;
use WechatShop\Kernel\Http\Response;
use WechatShop\Kernel\Support\Collection;
...
trait ResponseCastable
{
     ...
     *
     * @return array|\WechatShop\Kernel\Support\Collection|object|\Psr\Http\Message\ResponseInterface|string
     *
